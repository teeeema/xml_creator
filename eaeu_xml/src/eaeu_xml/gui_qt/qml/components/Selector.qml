...
ColumnLayout { id: root; property string title: ""; property var items: []; property string code: ""; signal chosen(string value); spacing: 3
    ...
    ComboBox { id: box; Layout.fillWidth: true; model: root.items; textRole: "label"; valueRole: "code"; currentIndex: indexOfValue(root.code); onActivated: root.chosen(currentValue) }
}
