# P.MM.06.MSG.018 requirements audit

- Structure: `R.HC.MM.06.003`
- Status: `TABLE_FOUND`
- Table: `19`
- Raw / structured: **13 / 13**
...
- Source: table 19, PDF page(s) 148–148
...
- Source: table 19, PDF page(s) 148–149
- Semantic category: `CONDITIONAL`
...
- Source: table 19, PDF page(s) 149–149
- Semantic category: `CONDITIONAL`
...
- Source: table 19, PDF page(s) 149–150
- Semantic category: `CONDITIONAL`
- Literal field references: `hcsdo:MedicalProductRegistrationFileCode`, `hcsdo:MedicalProductRegistrationFileName`
- Mapping: `PARTIAL`
...
- Source: table 19, PDF page(s) 150–150
